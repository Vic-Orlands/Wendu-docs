...
## See full code and architectural structure?

<Card title="Pages Documentation" href="/quickstart#project-structure">
  View the complete pages code structure
</Card>

<Card title="Architecture Diagram" href="/development/architecture-diagram">
  Visualize the component structure and data flow
</Card>
